...
@section('content')
	...
	<a href="{{ route('members.status_aduan.index') }}"><button class="btn btn-success">Senarai Status Aduan</button></a><br /><br />

	@include('messages._formErrors')

	{!! Form::model($saduan, ['route' => ['members.status_aduan.show', $saduan->id]]) !!}

	<table class="table table-bordered table-striped">
		<tr>
			<thead><th colspan="2"><h4>Kemaskini Status Aduan</h4></th></thead>
		</tr>
		<tr>
